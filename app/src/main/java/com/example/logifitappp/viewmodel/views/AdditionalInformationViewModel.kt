...
@HiltViewModel(assistedFactory = AdditionalInformationViewModel.AdditionalInformationViewModelFactory::class)
class AdditionalInformationViewModel @AssistedInject constructor (
    ...
    @AssistedFactory
    interface AdditionalInformationViewModelFactory {
        fun create(user: UserModel?): AdditionalInformationViewModel
    }
    ...
    fun storePersonalInformation() {
        ...
        viewModelScope.launch {
            try {
                ...
                userService.storePersonalInformation(user.id, StorePersonalInformationRequest(
                ...
                App.database.userDao().store(user.copy(
    ...
    fun storeProfilePhoto() {
        ...
        viewModelScope.launch {
            try {
                ...
                state = state.copy(storingInformationStatus = AppStatusCodeEnum.FAILED_PROFILE_PHOTO_STORE)
            }
        }
    }
