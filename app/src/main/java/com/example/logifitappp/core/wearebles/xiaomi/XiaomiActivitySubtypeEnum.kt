...
enum class XiaomiActivitySubtypeEnum(private val type: XiaomiActivityTypeEnum, private val code: Int) {
    ...
    SPORTS_TREADMILL(XiaomiActivityTypeEnum.SPORTS, 0x03),
    SPORTS_OUTDOOR_CYCLING_V2(XiaomiActivityTypeEnum.SPORTS, 0x06),
    ...
    SPORTS_ROWING(XiaomiActivityTypeEnum.SPORTS, 0x0d),
    SPORTS_ELLIPTICAL(XiaomiActivityTypeEnum.SPORTS, 0x0B),
    SPORTS_JUMP_ROPING(XiaomiActivityTypeEnum.SPORTS, 0x0e),
