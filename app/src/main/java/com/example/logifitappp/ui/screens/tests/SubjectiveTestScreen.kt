...
@Composable
fun SubjectiveTestScreen( navigation: NavHostController) {
    Column(
        modifier = Modifier.fillMaxSize()
    ) {
        BackHeader(
            navigation = navigation,
            title = stringResource(id = R.string.subjective_test)
        )
        SimplePage(
            content = {
                CardLayout(
...
@Composable
fun SubjectiveTestScreenPreview() {
    LogifitApppTheme {
        SubjectiveTestScreen(navigation = rememberNavController())
    }
}
@Preview(showBackground = true)
@Composable
fun SubjectiveTestScreenDarkModePreview() {
