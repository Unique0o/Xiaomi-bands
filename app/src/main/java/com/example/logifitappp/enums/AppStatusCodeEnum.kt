...
enum class AppStatusCodeEnum(
    ...
    FETCHING_XIAOMI_MACS(321, R.string.fetching_xiaomi_macs_message, true, { Loader() }),
    ...
    STORING_XIAOMI_MACS(324, R.string.storing_xiaomi_macs_message, true, { Loader() }),
    ...
    SUCCESSFUL_XIAOMI_MACS_STORAGE(325, R.string.successful_xiaomi_macs_storage_message, false, { AnimatedSuccessSignal() }),
    TRANSFERRING_WEARABLE_INFORMATION(126, R.string.transferring_wearable_information_message, true, { AnimatedDataTransfer() }),
    UNAUTHORIZED_FOR_MAC_EXTRACTION(322, R.string.unauthorized_for_mac_extraction_message, false, { AnimatedErrorSignal() }),
    ...
    XIAOMI_MAC_LIST_EMPTY(323, R.string.xiaomi_mac_empty_list_message, false, { AnimatedWarningSignal() });
